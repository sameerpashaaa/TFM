...
export default function Navbar() {
  ...
  return (
    <nav style={{ background: '#fff', borderBottom: '1px solid #E8DFD4', position: 'relative' }}>
      {/* Main category nav */}
      <div className="container" style={{ display: 'flex', justifyContent: 'center', gap: 0, position: 'relative' }}>
        {navCategories.map(cat => (
          ...
          >
            ...
            {hoveredCat === cat.slug && (
              <div
                style={{
                  position: 'absolute', top: '100%', left: cat.sections ? -100 : 0,
                  width: cat.sections ? 'max-content' : 240, background: '#fff',
                        ...
                        {sect.items.map(item => (
                          <Link
                            ...
                            style={{
                              ...
                              fontSize: 13, fontWeight: 500, color: '#5E554C',
                    ...
                    {cat.subCategories?.map(sub => (
                      <Link
                        ...
                        style={{
                          ...
                          fontSize: 13, fontWeight: 500, color: '#4A423B',
                          textDecoration: 'none', transition: 'all .15s',
                        }}
                        onMouseEnter={e => {
      ...
      {/* Info links row */}
      <div style={{ background: '#FAF6F1', borderTop: '1px solid #F2EBE2' }}>
          ...
          {infoLinks.map(link => (
            <Link
              ...
              style={{
                ...
                letterSpacing: 0.6, color: '#7C7268', textDecoration: 'none',
                transition: 'color .2s',
              }}
